...
public sealed class InterfaceBoxingDemoTests
{
    private readonly InterfaceBoxingDemo _sut = new();
    ...
    [Fact]
    public void Optimized_ThrowsArgumentOutOfRangeException_WhenCountIsZero()
    {
        // Act
